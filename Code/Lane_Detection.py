    ...
    def parse_events(self, client, world, clock):
        ...
        if not self._autopilot_enabled:
            if isinstance(self._control, carla.VehicleControl):
                ...
                # self._control.steer = 0.5

                global test_con
                '''
                if test_con == 1 :
                    #self._control.steer = 0.8
                    print('test_con2=', test_con)
                else :
                    #self._control.steer = 0.0
                    print('test_con3=', test_con)
                '''
...
class CameraManager(object):
    def __init__(self, parent_actor, hud):
        ...
        self._camera_transforms = [
            carla.Transform(carla.Location(x=-1, z=2.8), carla.Rotation(pitch=-15)),
...
def game_loop(args):
    ...
    try:
        ...
        # Changing The Map
        world = World(client.load_world('Town02'), hud, args.filter,
